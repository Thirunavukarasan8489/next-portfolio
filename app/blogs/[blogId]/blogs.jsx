...
export default function Blogs({ blogId }) {
  ...
  useEffect(() => {
    ...
    if (!cachedBlogLinks && blogLinks) {
      setCachedBlogLinks(blogLinks);
    }
  }, [blogLinks, cachedBlogLinks]);
  ...
  if (loading) {
    return (
      ...
      //     <div className="h-12 w-12 rounded-full bg-[#94a3b8]"></div>
      //     <div className="flex-1">
      //       <div className="mb-1 h-5 w-3/5 rounded-lg bg-[#94a3b8] text-lg"></div>
      //       <div className="h-5 w-[90%] rounded-lg bg-[#94a3b8] text-sm"></div>
      //     </div>
      //     <div className="absolute bottom-5 right-0 h-4 w-4 rounded-full bg-[#94a3b8]"></div>
      //   </div>
      // </div>
    );
  }
